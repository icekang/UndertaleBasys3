...
module FightButtonSprite(
    ...
    output reg FightSpriteOn, // 1=on, 0=off
    ...
    FightButtonRom FightRom  (.i_addr(address),.i_clk(Pclk),.o_data(dataout));
    
    // setup character positions and sizes
    reg [9:0] BtnX = 197; // Bee X start position
